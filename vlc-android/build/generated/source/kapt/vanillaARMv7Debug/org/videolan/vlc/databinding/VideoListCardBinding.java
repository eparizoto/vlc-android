...
public class VideoListCardBinding extends android.databinding.ViewDataBinding  {
    ...
    public VideoListCardBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x240L) != 0) {
            ...
            this.mlItemProgress.setSecondaryProgress(max);
    ...
    @NonNull
    public static VideoListCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static VideoListCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
    ...
    @NonNull
    public static VideoListCardBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static VideoListCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(org.videolan.vlc.R.layout.video_list_card, null, false), bindingComponent);
    }
    @NonNull
    public static VideoListCardBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static VideoListCardBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
    ...
    /* flag mapping
        ...
        flag 12 (0xdL): max == 0 ? View.INVISIBLE : View.VISIBLE
        flag 13 (0xeL): max == 0 ? View.INVISIBLE : View.VISIBLE
    flag mapping end*/
    //end
}