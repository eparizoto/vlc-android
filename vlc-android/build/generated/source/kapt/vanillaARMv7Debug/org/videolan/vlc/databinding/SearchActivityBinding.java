...
public class SearchActivityBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    @NonNull
    public final android.support.v7.widget.RecyclerView albumsResults;
    @NonNull
    public final android.support.v7.widget.RecyclerView artistsResults;
    @NonNull
    public final android.support.v7.widget.RecyclerView episodesResults;
    @NonNull
    public final android.support.v7.widget.RecyclerView genresResults;
    @NonNull
    ...
    @NonNull
    public final android.support.v7.widget.RecyclerView moviesResults;
    @NonNull
    public final android.support.v7.widget.RecyclerView othersResults;
    @NonNull
    public final android.support.v7.widget.RecyclerView playlistsResults;
    @NonNull
    ...
    @NonNull
    public final android.support.v7.widget.RecyclerView songsResults;
    // variables
    @Nullable
    ...
    public SearchActivityBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        super(bindingComponent, root, 0);
        final Object[] bindings = mapBindings(bindingComponent, root, 24, sIncludes, sViewsWithIds);
        this.albumsResults = (android.support.v7.widget.RecyclerView) bindings[5];
        this.albumsResults.setTag(null);
        this.artistsResults = (android.support.v7.widget.RecyclerView) bindings[7];
        this.artistsResults.setTag(null);
        this.episodesResults = (android.support.v7.widget.RecyclerView) bindings[13];
        this.episodesResults.setTag(null);
        this.genresResults = (android.support.v7.widget.RecyclerView) bindings[9];
        ...
        this.moviesResults = (android.support.v7.widget.RecyclerView) bindings[15];
        this.moviesResults.setTag(null);
        this.othersResults = (android.support.v7.widget.RecyclerView) bindings[17];
        this.othersResults.setTag(null);
        this.playlistsResults = (android.support.v7.widget.RecyclerView) bindings[11];
        ...
        this.songsResults = (android.support.v7.widget.RecyclerView) bindings[19];
    ...
    @NonNull
    public static SearchActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static SearchActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
    ...
    @NonNull
    public static SearchActivityBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static SearchActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(org.videolan.vlc.R.layout.search_activity, null, false), bindingComponent);
    }
    @NonNull
    public static SearchActivityBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static SearchActivityBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
